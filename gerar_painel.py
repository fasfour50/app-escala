    ...
    with pdfplumber.open(caminho_pdf) as pdf:
        for pagina in pdf.pages:
            ...
            for linha in linhas:
                ...
                # Extração correta do HSB com intervalo exato (ex: 03:30-04:48)
                ...
                # Extração correta para APZ/Duty capturando linhas de apresentação isoladas
...
def gerar_escala_html(eventos):
    ...
    if not escala_por_dia:
        print("⚠️ Nenhum evento extraído do PDF.")
        return None
...
if __name__ == "__main__":
    ...
    if caminho_html:
        print(f"✅ HTML gerado com sucesso: {caminho_html}")
